                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    @if(isset($book->downloadable))
                                        <span class="text-gray-500"><a href="{{ asset('storage/'.$book->downloadable) }}" target="_blank">Sí</a></span>
                                    @else
                                        <span class="text-gray-500">NO</span>
                                    @endif
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('book.edit', ['slug' => $book->slug]) }}" class="text-indigo-600 hover:text-indigo-900" style="min-width: 20px; text-align:center; margin: 5px 0;"><i class="fas fa-edit text-lg"></i></a>
                                    <form class="" style="min-width: 20px; text-align:center; margin: 5px 0;" method="POST" action="{{ route('book.destroy', ['slug' => $book->slug]) }}">
                                    @csrf
                                    @method('DELETE')
