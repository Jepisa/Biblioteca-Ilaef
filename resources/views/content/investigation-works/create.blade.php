        ...
        <div class="flex justify-center px-6 my-12">
            ...
            <div class="w-full">
                <div class="w-full bg-white p-5 rounded-lg lg:rounded-l-none">
                    <h3 class="pt-4 text-2xl text-center">{{ __('investigation-works.create.title') }}</h3>
                    <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded" method="POST" action="{{ route('investigationwork.store') }}" enctype="multipart/form-data">
                        @csrf

                        {{-- Titulo --}}
                        <div class="mb-2 w-6/12">
                            <label class="block mb-1 text-sm font-bold text-gray-700" for="title">
                                {{ __('investigation-works.create.fields.title.label') }}
                            </label>
                            <input
                        ...
                        <div class="mb-4 md:flex md:justify-between">
                            ...
                            <div class="w-5/12 mb-2" >
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="select">{{ __('investigation-works.create.fields.authors.label') }}</label>
                            ...
                            {{-- Temas --}}
                            <div class="w-5/12 mb-2" >
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="topics">{{ __('investigation-works.create.fields.topics.label') }}</label>
                        ...
                        <div class="mb-4 md:flex md:justify-between">
                            ...
                            <div class="mb-2 w-4/12">
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="synopsis">
                                    {{ __('investigation-works.create.fields.synopsis.label') }}
                                </label>
                                <textarea
                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="synopsis"
                            ...
                            <div class="mb-2 w-4/12">
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="note">
                                    {{ __('investigation-works.create.fields.notes.label') }}
                                </label>
                                <textarea
                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="note"
                            ...
                            <div class="mb-2 w-4/12">
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="year">
                                    {{ __('investigation-works.create.fields.year.label') }}
                                </label>
                                <input
                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="year"
                        ...
                        <div class="mb-4 md:flex md:justify-between">
                            ...
                            <div class="mb-2 w-3/12">
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="sources">
                                    {{ __('investigation-works.create.fields.sources.label') }}
                                </label>
                                <input
                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="sources"
                            ...
                            <div class="mb-2 w-3/12">
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="language_id">
                                    {{ __('investigation-works.create.fields.language.label') }}
                                </label>
                        ...
                        <div class="mb-4 md:flex md:justify-between">
                            ...
                            <div class="mb-2 w-3/12">
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="city">
                                    {{ __('investigation-works.create.fields.city.label') }}
                                </label>
                                <input
                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="city"
                            ...
                            <div class="mb-2 w-3/12">
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="country_id">
                                    {{ __('investigation-works.create.fields.country.label') }}
                                </label>
                            ...
                            <div class="mb-2 w-3/12">
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="pages">
                                    {{ __('investigation-works.create.fields.pages.label') }}
                                </label>
                                <input
                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="pages"
                            ...
                            <div class="mb-2 w-3/12">
                                <label class="block mb-1 text-sm font-bold text-gray-700" for="isbn">
                                    {{ __('investigation-works.create.fields.isbn.label') }}
                                </label>
                                <input
                                    class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                    id="isbn"
                                    ...
                                    type="text"
                                    max="255"
                                    placeholder="{{ __('investigation-works.create.fields.isbn.placeholder') }}"
                                />
                            </div>
                        </div>
                        {{-- URL --}}
                        <div class="mb-2">
                            <label class="block mb-1 text-sm font-bold text-gray-700" for="url">
                                {{ __('investigation-works.create.fields.url.label') }}
                            </label>
                            ...
                            <div class="mb-4 md:flex md:justify-between">
                                ...
                                <div class="mb-2 w-2/12">
                                    <label class="block mb-1 text-sm font-bold text-gray-700" for="downloadable">
                                        {{ __('investigation-works.create.fields.downloadable.label') }}
                                    </label>
                                ...
                                <div class="mb-2 w-2/12">
                                    <label class="block mb-1 text-sm font-bold text-gray-700" for="coverImage">
                                        {{ __('investigation-works.create.fields.cover.label') }}
                                    </label>
                                ...
                                <div class="mb-2 w-2/12">
                                    <label class="block mb-1 text-sm font-bold text-gray-700" for="backCoverImage">
                                        {{ __('investigation-works.create.fields.backcover.label') }}
                                    </label>
                            ...
                            <div class="mb-4 md:flex md:justify-between">
                                ...
                                <div class="mb-2 w-2/12">
                                    <label class="block mb-1 text-sm font-bold text-gray-700" for="extraImages">
                                        {{ __('investigation-works.create.fields.extraimages.label') }}
                                    </label>
                        ...
                        <div class="mb-6 text-center">
                            <button
                                ...
                                type="submit"
                            >
                            {{ __('investigation-works.create.buttons.submit') }}
                            </button>
                        </div>
