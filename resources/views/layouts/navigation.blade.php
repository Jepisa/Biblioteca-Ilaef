<div class="pt-2 mb-4 lg:mb-10">
    <nav class="nav-principal rounded-xl" x-data="{ open: false }">
        ...
        <div class="navbar w-full h-full z-50">
            <div class="flex justify-between h-full">
                            ...
                            <x-slot name="content">
                                ...
                                @foreach (App\Models\User::all() as $user)
                                    <form method="POST" action="{{ route('impersonate.start', [$user->id]) }}"
                                        class="{{ Auth::user()->email == $user->email ? 'border font-black' : '' }}">
                                        @csrf

                                        <x-dropdown-link :href="route('impersonate.start', [$user->id])" onclick="event.preventDefault();
                                                                            this.closest('form').submit();">
                ...
                <!-- Hamburger -->
                <div class="-mr-2 flex items-center sm:hidden bg-transparent" id="open-close-nav">
                    <a id="hamburger-icon"
                        class="inline-flex items-center justify-center p-2 mr-4 rounded-md text-gray-400 focus:outline-none focus:text-gray-500 transition duration-150 ease-in-out bg-transparent">
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
        ...
        <div class="menu_desplegable">
            <div class="menu_desplegable_content">
                <div>
