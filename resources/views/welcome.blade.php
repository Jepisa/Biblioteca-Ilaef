<x-app-layout>
    ...
    <x-carrousel-of-advertisement/>
    <x-searcher/>

    <x-carrousel :titleOfCarousel="'Nuestros recomendados'" :carousel="'nuestros-recomendados'" :books="$books"/>
    <x-carrousel :titleOfCarousel="'Los más buscados'" :carousel="'los-más-buscados'" :books="$books"/>
    <x-carrousel :titleOfCarousel="'Los últimos cargados'" :carousel="'los-últimos-cargados'" :books="$books"/>
    ...
    <x-slot name="scriptsDown">
        <script>
            ...
            new Glide('.carrousel-of-advertisement', configA).mount();
            
            document.addEventListener("DOMContentLoaded", function(event) {
                let carrouselYes = document.querySelectorAll("#imagenes-carousel");
